...
public class Canvas
{
    ...
    /**
     * A method to get the the width of a text drawn on the canvas
     *
    ...
    public double getTextWidth(String text)
    {
        ...
        Rectangle2D textBound = getFont().getStringBounds(text, frc);
        return textBound.getWidth();
    }
  /**
     * A method to get the the height of a text drawn on the canvas
     *
     * @param  text the text for which height to be found
     * @return     the height
     */
